...
apt:
  ...
  security:
    - arches: [default]
      uri: https://${apt_mirror}/ubuntu
%{ else ~}
%{ if instance.os_family == "rhel" && use_yum_mirror ~}
write_files:
  - path: /etc/yum.repos.d/centos.repo
    content: |
      # This file has been replaced by cloud-init
      # Original file is backed up as centos.repo.bak (if existed)
      # All repository definitions are now in separate files under /etc/yum.repos.d/
      # Please do not edit this file directly.
  - path: /etc/yum.repos.d/centos-addons.repo
    content: |
      # This file has been replaced by cloud-init
      # Original file is backed up as centos-addons.repo.bak (if existed)
      # All repository definitions are now in separate files under /etc/yum.repos.d/
yum_repos:
  centos-baseos:
  ...
  centos-crb:
    ...
    baseurl: https://${yum_mirror}/centos-stream/$releasever-stream/CRB/$basearch/os/
    enabled: false
    gpgcheck: true
    gpgkey: file:///etc/pki/rpm-gpg/RPM-GPG-KEY-centosofficial
  ...
  epel:
    ...
    baseurl: https://${yum_mirror}/epel/$releasever/Everything/$basearch/
    enabled: true
    gpgcheck: true
    gpgkey: https://${yum_mirror}/epel/RPM-GPG-KEY-EPEL-9
